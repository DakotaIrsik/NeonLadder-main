...
public class LightPulse: MonoBehaviour
{
    ...
    public float maxValueIntensity = 5f;
    public float minValueIntensity = 1f;
    ...
    void Update()
    {
        ...
        float intensity = Mathf.Lerp(minValueIntensity, maxValueIntensity, Mathf.PingPong(Time.time, 1f));
